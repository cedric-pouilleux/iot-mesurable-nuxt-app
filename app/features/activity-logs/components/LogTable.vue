      ...
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          <tr
            ...
            :key="log.id"
            :class="{
              'bg-red-50 dark:bg-red-900/10': log.level === 'error' || log.level === 'fatal',
              'bg-amber-50 dark:bg-amber-900/10': log.level === 'warn',
            }"
          >
            ...
            <td class="text-center">
              <Icon
                ...
                :title="
                  log.direction === 'OUT' ? $t('logs.direction.out') : $t('logs.direction.in')
                "
              />
            </td>
            ...
            <td class="text-sm text-gray-900 dark:text-gray-300">
              ...
              >
                <template #trigger>
                  <span
                    class="cursor-pointer border-b border-dotted border-gray-400 dark:border-gray-600 hover:text-indigo-600 dark:hover:text-indigo-400"
                  >
                    {{ log.msg }}
                  </span>
                </template>
                <template #content>
                  <div class="text-xs space-y-1">
                    <div
                      v-for="(line, i) in log.details.details as string[]"
                      :key="i"
                      class="flex gap-1"
                    >
