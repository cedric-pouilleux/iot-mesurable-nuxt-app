    ...
    >
      ...
      >
        ...
        <div class="p-6 overflow-auto custom-scrollbar">
          <div
            class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 font-mono text-xs text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700"
          >
