<template>
  <UIPanel title="Configuration des cartes">
    <!-- Minimalist Mode -->
    <div
      class="flex items-center justify-between mb-3 pb-3 border-b border-dashed border-gray-200 dark:border-gray-700"
    >
      <span class="text-xs font-medium text-gray-700 dark:text-gray-200"
        >Affichage minimaliste</span
      >
    ...
    <div
      ...
      :class="
        !minimalMode ? 'mb-3 pb-3 border-b border-dashed border-gray-200 dark:border-gray-700' : ''
      "
    >
    ...
    <template v-if="!minimalMode">
      <div class="space-y-4">
        ...
        <div>
          <span class="text-[11px] text-gray-400 uppercase font-bold tracking-wider mb-2 block"
            >Graphiques</span
          >
          <div class="grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div class="col-span-2 flex items-center justify-between">
              ...
              <UITooltip
                text="Utiliser une échelle Y fixe (0-100% ou max capteur) pour comparer visuellement"
              >
