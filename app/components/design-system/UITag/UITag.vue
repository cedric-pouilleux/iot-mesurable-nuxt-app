...
const variantClasses = computed(() => {
  if (props.outlined) {
    switch (props.variant) {
      case 'primary':
        return 'border-blue-500 text-blue-600 dark:text-blue-400 bg-transparent'
      case 'success':
        return 'border-green-500 text-green-600 dark:text-green-400 bg-transparent'
      case 'warning':
        return 'border-orange-500 text-orange-600 dark:text-orange-400 bg-transparent'
      case 'error':
        return 'border-red-500 text-red-600 dark:text-red-400 bg-transparent'
      case 'blue':
        return 'border-blue-500 text-blue-600 dark:text-blue-400 bg-transparent'
      default:
        return 'border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 bg-transparent'
    }
  }
  ...
  switch (props.variant) {
    case 'primary':
      return 'bg-blue-600 text-white border-blue-600 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-800'
    case 'success':
      return 'bg-green-600 text-white border-green-600 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800'
    case 'warning':
      return 'bg-orange-500 text-white border-orange-500 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800'
    case 'error':
      return 'bg-red-600 text-white border-red-600 dark:bg-red-900/40 dark:text-red-300 dark:border-red-800'
    case 'blue':
      return 'bg-blue-500 text-white border-blue-500 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-800'
    default:
...
const sizeClasses = computed(() => {
  switch (props.size) {
    ...
    default:
      return 'text-[10px] px-1.5 py-0.5' // xs (default)
  }
})
</script>
