<template>
  <div class="relative" :class="{ 'opacity-40': disabled }">
    <div
      class="relative w-20 h-3.5 rounded-md bg-gray-700 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 dark:border-t dark:border-blue-400/50 dark:shadow-[0_0_2px_rgba(0,0,0,0.9)]"
    >
      <span
        v-if="showValue"
